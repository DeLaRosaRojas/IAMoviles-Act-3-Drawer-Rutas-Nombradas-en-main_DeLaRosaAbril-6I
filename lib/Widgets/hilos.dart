...
class HilosPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Sección Hilos")),
      drawer: const MenuLateral(),
      body: Center(
        child: Image.network(
          'https://raw.githubusercontent.com/DeLaRosaRojas/IAMoviles-Act-3-Drawer-Rutas-Nombradas-en-main_DeLaRosaAbril-6I/refs/heads/main/ProdHilo.png',
